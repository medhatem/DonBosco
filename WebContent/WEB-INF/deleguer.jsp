      ...
      <div class="container">
        <div class="row">
          <div
            ...
            style="background-color: #1abc9C; margin-right: 1.5cm;"
          >
          <br></br>
              ...
              <div class="container">
                ...
                <div >
                    <div class="form-group">
                      ...
                      <br></br>
                      <div  >
                        <button class="button mb-4 text-black" style="position:absolute;right:0.75cm;">Inviter</button>
                      </div>
                      <br></br><br></br>
