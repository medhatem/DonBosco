            ...
            <section class=" text-center text-white">
				...
				<div class="row" id="RowRadio">
					<div class="col-sm-5">
						<div class="radio">
						  <label>
						    <H5><input type="radio" name="optionsRadios" id="optionsRadios1" value="option1">
						    Je serai présent</H5>
						  </label>
						</div>
						<div class="radio">
						  <label>
						    <H5><input type="radio" name="optionsRadios" id="optionsRadios2" value="option2">
						    Je ne serai pas présent</H5>
						  </label>
						</div>
						<div class="radio">
						  <label>
						    <H5><input type="radio" name="optionsRadios" id="optionsRadios3" value="option3">
						    je ne sais pas encore</H5>
						  </label>
						</div>
					</div>
					<div class="col-sm-3 col-sm-offset-2">
						...
						<%--<INPUT TYPE="SUBMIT" class="button mb-4 text-black" VALUE="Enregistrer" id="Eng">--%>
					</div>
				</div>
            </section>
          </div>
